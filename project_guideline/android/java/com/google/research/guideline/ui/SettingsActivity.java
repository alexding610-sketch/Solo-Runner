...
/**
 * Settings activity with accessibility navigation.
 */
public class SettingsActivity extends AppCompatActivity {
  ...
  private static class MenuItem {
    ...
    MenuItem(String label, String key) {
      this.label = label;
      this.key = key;
    }
  }
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    menuItems.add(new MenuItem("音量设置", "volume"));
    menuItems.add(new MenuItem("语音速度", "speech_rate"));
    menuItems.add(new MenuItem("关于应用", "about"));
  ...
  private void selectCurrentItem() {
    ...
    if (ttsInitialized) {
      tts.speak("选择" + item.label, TextToSpeech.QUEUE_FLUSH, null, null);
    }
